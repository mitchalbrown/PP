...
class SwiftPageBuilderShortcode_spb_faqs extends SwiftPageBuilderShortcode {
    ...
    public function content( $atts, $content = null ) {
        ...
        $category_id = $category_name = "";
       	...
       	if ( empty($cats) ) {
       		$items .= '<h4>'.__("Please ensure you have child categories for the selected category.", "swiftframework").'</h4>';
       	}
...
SPBMap::map( 'spb_faqs', array(
    ...
    "params"	=> array(
    	...
    	array(
    	    "type"        => "dropdown",
    	    "heading"     => __( "FAQ category", "swift-framework-admin" ),
    	    "param_name"  => "category",
    	    "value"       => sf_get_category_list( 'faqs-category' ),
    	    "description" => __( "Choose the category for the FAQ.", "swift-framework-admin" )
    	),
        array(
            "type" => "textfield",
