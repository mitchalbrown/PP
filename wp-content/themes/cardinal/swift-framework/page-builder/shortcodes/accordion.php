    ...
    */
    ...
    class SwiftPageBuilderShortcode_spb_accordion_tab extends SwiftPageBuilderShortcode {
        ...
        protected function content( $atts, $content = null ) {
            ...
            if ( $icon != "" ) {
                $output .= "\n\t\t\t\t" . '<h4><a href="#"><i class="' . $icon . '"></i>' . $title . '</a></h4>';
            } else {
        ...
        public function contentAdmin( $atts, $content = null ) {
            $title    = '';
            $icon     = '';
            $defaults = array( 'title' => __( 'Section', 'swift-framework-admin' ), 'icon' => '' );
            extract( shortcode_atts( $defaults, $atts ) );

            return '<div class="group">
			<h3 data-title-icon="' . $icon . '"><a class="title-text" href="#">' . $title . '</a><a class="delete_tab"></a><a class="edit_tab"></a></h3>
			<div>
