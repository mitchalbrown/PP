    ...
    */
    ...
    SPBMap::map( 'spb_icon_box', array(
        ...
        "params"        => array(
            ...
            array(
                "type"        => "colorpicker",
                "heading"     => __( "Icon Background color", "swift-framework-admin" ),
                "param_name"  => "icon_bg_color",
                "value"       => "",
                "description" => __( "Set the icon background colour for the icon box, or leave blank to use the default colours.", "swift-framework-admin" )
            ),
            array(
                "type"        => "colorpicker",
