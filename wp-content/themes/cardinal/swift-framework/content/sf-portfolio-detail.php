    ...
    if ( ! function_exists( 'sf_portfolio_detail_media' ) ) {
        function sf_portfolio_detail_media() {
            ...
            <?php if ( $fw_media_display == "fw-media" ) { ?>
                <figure class="media-wrap fw-media-wrap media-type-<?php echo $media_type; ?>">
            <?php } else if ( $fw_media_display == "split" ) { ?>
                <figure class="media-wrap col-sm-9 media-type-<?php echo $media_type; ?>">
            <?php } else { ?>
                <figure class="media-wrap container media-type-<?php echo $media_type; ?>">
            <?php } ?>
            ...
            <?php
                ...
                <?php if ( $detail_image ) { ?>
                    ...
                    <img itemprop="image" src="<?php echo $detail_image[0]; ?>" width="<?php echo $detail_image[1]; ?>"
                         height="<?php echo $detail_image[2]; ?>" alt="<?php echo $image_alt; ?>"/>
...
<section class="item-details">
    ...
    <section class="item-details col-sm-3">
        ...
        <?php if ( $item_link != "" ) { ?>
            <a class="item-link" href="<?php echo $item_link; ?>" target="_blank"><i
                    class="ss-link"></i><?php _e( "View Project", "swiftframework" ); ?></a>
        <?php } ?>
                                ...
                                <figure class="animated-overlay overlay-style">
                                    ...
                                    <figcaption <?php echo $port_hover_style; ?>>
                                        <div class="thumb-info">
                                            <h4 <?php echo $port_hover_text_style; ?>><?php echo $item_title; ?></h4>

                                            <div class="name-divide"></div>
                                            <h5 <?php echo $port_hover_text_style; ?>><?php echo $item_subtitle; ?></h5>
                                        </div>
                                    </figcaption>
                                </figure>
                            </article>
