<?php
	...
	*/
    ...
    function sf_iconbox( $atts, $content = null ) {
        ...
        if ( $type == "standard" && sf_theme_opts_name() == "sf_joyn_options" ) {
    ...
    if ( ! $disable_sfgallery ) {
        ...
        function sf_gallery( $attr ) {
            ...
            $output = "<div id='$selector' class='gallery galleryid-{$id} gallery-columns-{$columns} gallery-size-{$size_class}' '$list_class'>";
