        ...
        function sf_page_heading() {
            ...
            if ( ! is_home() ) {
                ...
                <?php if ( $page_title_style == "fancy" || $page_title_style == "fancy-tabbed" ) { ?>
                    ...
                    <div class="fancy-heading-wrap <?php echo $page_title_style; ?>-style">
                ...
                <?php } else { ?>
                    ...
                    <div class="container">
                        ...
                        <?php if ( is_singular( 'galleries' ) && ! ( sf_theme_opts_name() == "sf_joyn_options" && $pagination_style == "fs-arrow" ) ) { ?>
                            <div class="prev-item" <?php echo $article_heading_text; ?>><?php next_post_link( '%link', '<i class="ss-navigateleft"></i>', false, '', 'gallery-category' ); ?></div>
                            <div class="next-item" <?php echo $article_heading_text; ?>><?php previous_post_link( '%link', '<i class="ss-navigateright"></i>', false, '', 'gallery-category' ); ?></div>
                        <?php } ?>
