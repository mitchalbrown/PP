    ...
    if ( ! function_exists( 'sf_get_cart' ) ) {
        function sf_get_cart() {
            ...
            if ( sf_woocommerce_activated() ) {
                ...
                if ( $show_cart_count ) {
                    $cart_output .= '<li class="parent shopping-bag-item"><a class="cart-contents" href="' . $woocommerce->cart->get_cart_url() . '" title="' . __( "View your shopping cart", "swiftframework" ) . '">'. apply_filters( 'sf_header_cart_icon', '<i class="ss-cart"></i>' ) . $cart_total . ' (' . $cart_count . ')<span class="num-items">' . $cart_count_text_alt . '</span></a>';
                } else {
